...
b,n=k?k.shortMonths:e;k="";var p=!1;l=l&&l.getTime?l:l?new Date(l):new Date;if(isNaN(l))throw SyntaxError("invalid date");"UTC:"===q.slice(0,4)&&(q=q.slice(4),p=!0);k=p?"getUTC":"get";var t=l[k+"Date"](),u=l[k+"Day"](),s=l[k+"Month"](),v=l[k+"FullYear"](),w=l[k+"Hours"](),z=l[k+"Minutes"](),D=l[k+"Seconds"](),C=l[k+"Milliseconds"](),x=p?0:l.getTimezoneOffset();return k=q.replace(a,function(a){switch(a){case "D":return t;case "DD":return G(t,2);case "DDD":return m[u];case "DDDD":return h[u];case "M":return s+
1;case "MM":return G(s+1,2);case "MMM":return n[s];case "MMMM":return r[s];case "Y":return parseInt(String(v).slice(-2));case "YY":return G(String(v).slice(-2),2);case "YYY":return G(String(v).slice(-3),3);case "YYYY":return G(v,4);case "h":return w%12||12;case "hh":return G(w%12||12,2);case "H":return w;case "HH":return G(w,2);case "m":return z;case "mm":return G(z,2);case "s":return D;case "ss":return G(D,2);case "f":return String(C).slice(0,1);case "ff":return G(String(C).slice(0,2),2);case "fff":return G(String(C).slice(0,
...
(t-a.axisX.conversionParameters.minimum)+0.5<<0;p=a.axisY.conversionParameters.reference+a.axisY.conversionParameters.pixelPerUnit*(h[m].y-a.axisY.conversionParameters.minimum)+0.5<<0;r||z?(b.beginPath(),b.moveTo(n,p),A={x:n,y:p},v&&(d.beginPath(),d.moveTo(n,p)),z=r=!1):(b.lineTo(n,p),v&&d.lineTo(n,p),0==m%250&&c());var D=k.dataPointIds[m];this._eventManager.objectMap[D]={id:D,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:m,x1:n,y1:p};if(0!==h[m].markerSize&&(0<h[m].markerSize||0<k.markerSize)){t=
k.getMarkerProperties(m,n,p,b);g.push(t);if(!k.maxWidthInX||t.size>k.maxWidthInX)k.maxWidthInX=t.size/(1<a.axisX.conversionParameters.pixelPerUnit?a.axisX.conversionParameters.pixelPerUnit-1:a.axisX.conversionParameters.pixelPerUnit);D=B(D);v&&g.push({x:n,y:p,ctx:d,type:t.type,size:t.size,color:D,borderColor:D,borderThickness:t.borderThickness})}(h[m].indexLabel||k.indexLabel)&&this._indexLabels.push({chartType:"area",dataPoint:h[m],dataSeries:k,point:{x:n,y:p},color:w})}c();H.drawMarkers(g)}}b.restore();
...
(0-a.axisY.conversionParameters.minimum)+0.5<<0,s,w=null,x=!1;if(0<h.length){var z=k._colorSet[m%k._colorSet.length];for(b.fillStyle=z;m<h.length;m++)if(t=h[m].x.getTime?h[m].x.getTime():h[m].x,!(t<a.axisX.dataInfo.viewPortMin||t>a.axisX.dataInfo.viewPortMax)){var D=p;if("number"!==typeof h[m].y)c(),x=!0;else{n=a.axisX.conversionParameters.reference+a.axisX.conversionParameters.pixelPerUnit*(t-a.axisX.conversionParameters.minimum)+0.5<<0;p=a.axisY.conversionParameters.reference+a.axisY.conversionParameters.pixelPerUnit*
(h[m].y-a.axisY.conversionParameters.minimum)+0.5<<0;r||x?(b.beginPath(),b.moveTo(n,p),w={x:n,y:p},v&&(d.beginPath(),d.moveTo(n,p)),x=r=!1):(b.lineTo(n,D),v&&d.lineTo(n,D),b.lineTo(n,p),v&&d.lineTo(n,p),0==m%250&&(0>=a.axisY.minimum&&0<=a.axisY.maximum?s=u:0>a.axisY.maximum?s=f.y1:0<a.axisY.minimum&&(s=e.y2),b.lineTo(n,s),b.lineTo(w.x,s),b.closePath(),b.fill(),b.beginPath(),b.moveTo(n,p),v&&(d.lineTo(n,s),d.lineTo(w.x,s),d.closePath(),d.fill(),d.beginPath(),d.moveTo(n,p)),w={x:n,y:p}));D=k.dataPointIds[m];
this._eventManager.objectMap[D]={id:D,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:m,x1:n,y1:p};if(0!==h[m].markerSize&&(0<h[m].markerSize||0<k.markerSize)){t=k.getMarkerProperties(m,n,p,b);g.push(t);if(!k.maxWidthInX||t.size>k.maxWidthInX)k.maxWidthInX=t.size/(1<a.axisX.conversionParameters.pixelPerUnit?a.axisX.conversionParameters.pixelPerUnit-1:a.axisX.conversionParameters.pixelPerUnit);D=B(D);v&&g.push({x:n,y:p,ctx:d,type:t.type,size:t.size,color:D,borderColor:D,borderThickness:t.borderThickness})}(h[m].indexLabel||
...
y:r-x})}if(0<=p.dataPointIndexes[h]){var D=p.dataPointIds[p.dataPointIndexes[h]];this._eventManager.objectMap[D]={id:D,objectType:"dataPoint",dataSeriesIndex:n,dataPointIndex:p.dataPointIndexes[h],x1:q,y1:k}}if(0<=p.dataPointIndexes[h]&&0!==w.markerSize&&(0<w.markerSize||0<p.markerSize)){h=p.getMarkerProperties(l,q,k,c);d.push(h);if(!p.maxWidthInX||h.size>p.maxWidthInX)p.maxWidthInX=h.size/(1<a.axisX.conversionParameters.pixelPerUnit?a.axisX.conversionParameters.pixelPerUnit-1:a.axisX.conversionParameters.pixelPerUnit);
markerColor=B(D);v&&d.push({x:q,y:k,ctx:m,type:h.type,size:h.size,color:markerColor,borderColor:markerColor,borderThickness:h.borderThickness})}(w.indexLabel||p.indexLabel)&&this._indexLabels.push({chartType:"stackedArea",dataPoint:w,dataSeries:p,point:{x:q,y:k},color:b})}}for(;0<s.length;)z=s.pop(),c.lineTo(z.x,z.y),v&&m.lineTo(z.x,z.y);c.closePath();c.fill();c.beginPath();c.moveTo(q,k);v&&(m.closePath(),m.fill(),m.beginPath(),m.moveTo(q,k))}delete p.dataPointIndexes}H.drawMarkers(d);c.restore();
...
(h-a.axisX.conversionParameters.minimum)+0.5<<0;k=a.axisY.conversionParameters.reference+a.axisY.conversionParameters.pixelPerUnit*(k-a.axisY.conversionParameters.minimum)+0.5<<0;var D=f[h]?f[h]:0;k-=D;x.push({x:q,y:r-D});f[h]=r-k;if(w)c.beginPath(),c.moveTo(q,k),v&&(p.beginPath(),p.moveTo(q,k)),w=!1;else if(c.lineTo(q,k),v&&p.lineTo(q,k),0==l%250){for(;0<x.length;){var C=x.pop();c.lineTo(C.x,C.y);v&&p.lineTo(C.x,C.y)}c.closePath();c.fill();c.beginPath();c.moveTo(q,k);v&&(p.closePath(),p.fill(),p.beginPath(),
p.moveTo(q,k));x.push({x:q,y:r-D})}if(0<=u.dataPointIndexes[h]){var y=u.dataPointIds[u.dataPointIndexes[h]];this._eventManager.objectMap[y]={id:y,objectType:"dataPoint",dataSeriesIndex:t,dataPointIndex:u.dataPointIndexes[h],x1:q,y1:k}}if(0<=u.dataPointIndexes[h]&&0!==z.markerSize&&(0<z.markerSize||0<u.markerSize)){h=u.getMarkerProperties(l,q,k,c);e.push(h);if(!u.maxWidthInX||h.size>u.maxWidthInX)u.maxWidthInX=h.size/(1<a.axisX.conversionParameters.pixelPerUnit?a.axisX.conversionParameters.pixelPerUnit-
1:a.axisX.conversionParameters.pixelPerUnit);markerColor=B(y);v&&e.push({x:q,y:k,ctx:p,type:h.type,size:h.size,color:markerColor,borderColor:markerColor,borderThickness:h.borderThickness})}(z.indexLabel||u.indexLabel)&&this._indexLabels.push({chartType:"stackedArea100",dataPoint:z,dataSeries:u,point:{x:q,y:k},color:b})}}for(;0<x.length;)C=x.pop(),c.lineTo(C.x,C.y),v&&p.lineTo(C.x,C.y);c.closePath();c.fill();c.beginPath();c.moveTo(q,k);v&&(p.closePath(),p.fill(),p.beginPath(),p.moveTo(q,k))}delete u.dataPointIndexes}H.drawMarkers(e);
...
dataSeriesIndex:0};s.push(k);var n=f.indexLabel?f.indexLabel:r.indexLabel?r.indexLabel:f.label?f.label:r.label?r.label:"";h._eventManager.objectMap[l]=k;k.center={x:C.x,y:C.y};k.y=f.y;k.radius=y;k.indexLabelText=h.replaceKeywordsWithValue(n,f,r,b);k.indexLabelPlacement=r.indexLabelPlacement;k.indexLabelLineColor=f.indexLabelLineColor?f.indexLabelLineColor:r.indexLabelLineColor?r.indexLabelLineColor:f.color?f.color:r._colorSet[b%r._colorSet.length];k.indexLabelLineThickness=f.indexLabelLineThickness?
...
3*Math.PI/2-z&&k.midAngle<3*Math.PI/2+z)&&(f<=d/2&&!l?(k.hemisphere="left",f++):(k.hemisphere="right",l=!0))}}function d(){var a=h.plotArea.ctx;if(null!==u&&u.frame<u.maxFrames){0===u.frame&&(u.prevMaxAngle=s[0].startAngle);a.clearRect(p.x1,p.y1,p.width,p.height);for(var a=u.prevMaxAngle+2*Math.PI/u.maxFrames,b=0;b<m.length;b++){var g=0===b?s[b].startAngle:f,f=g+(s[b].endAngle-s[b].startAngle),l=!1;f>a&&(f=a,l=!0);var k=m[b].color?m[b].color:r._colorSet[b%r._colorSet.length];f>g&&ja(h.plotArea.ctx,
s[b].center,s[b].radius,k,r.type,g,f);if(l)break}u.frame++;u.prevMaxAngle=a;u.frame<u.maxFrames?h.animationRequestId=h.requestAnimFrame.call(window,d):(c(v?15:4),e())}}function e(){var a=h.plotArea.ctx;if(null!==u&&u.frame<u.maxFrames){a.clearRect(p.x1,p.y1,p.width,p.height);for(a=0;a<m.length;a++){var b=s[a].startAngle,c=s[a].endAngle;if(c>b){var d=0.07*y*Math.cos(s[a].midAngle),g=0.07*y*Math.sin(s[a].midAngle),f=!1;if(m[a].exploded){if(Math.abs(s[a].center.x-(C.x+d))>Math.abs(0.5*d/u.maxFrames)||
Math.abs(s[a].center.y-(C.y+g))>Math.abs(0.5*g/u.maxFrames))s[a].center.x+=d/u.maxFrames,s[a].center.y+=g/u.maxFrames,f=!0}else if(Math.abs(s[a].center.x-C.x)>Math.abs(0.5*d/u.maxFrames)||Math.abs(s[a].center.y-C.y)>Math.abs(0.5*g/u.maxFrames))s[a].center.x-=d/u.maxFrames,s[a].center.y-=g/u.maxFrames,f=!0;f&&(d={},d.dataSeries=r,d.dataPoint=r.dataPoints[a],d.index=a,h._toolTip.highlightObjects([d]));ja(h.plotArea.ctx,s[a].center,s[a].radius,m[a].color?m[a].color:r._colorSet[a%r._colorSet.length],
...
+d.toFixed(D)&&(c=h>w?-(h-w):-(n-(e-d)))))):0<h&&(e="right"===f.hemisphere?k:n,c=h,null!==e&&(n=h,h=s[e].indexLabelTextBlock.y-s[e].indexLabelTextBlock.height/2-(f.indexLabelTextBlock.y+f.indexLabelTextBlock.height/2),h-n<w&&(d=n,t++,e=q(e,d),+e.toFixed(D)<+d.toFixed(D)&&(c=h>w?h-w:n-(d-e)))));c&&(h=f.indexLabelTextBlock.y+c,d=0,d="right"===f.hemisphere?C.x+Math.sqrt(Math.pow(B,2)-Math.pow(h-C.y,2)):C.x-Math.sqrt(Math.pow(B,2)-Math.pow(h-C.y,2)),f.midAngle>Math.PI/2-z&&f.midAngle<Math.PI/2+z?(e=(a-
...
("right"===n.hemisphere&&d>n.indexLabelTextBlock.x)&&(d=n.indexLabelTextBlock.x-15)),f.indexLabelTextBlock.y=h,f.indexLabelTextBlock.x=d,f.indexLabelAngle=Math.atan2(f.indexLabelTextBlock.y-C.y,f.indexLabelTextBlock.x-C.x))}return c}function k(){var a=h.plotArea.ctx;a.fillStyle="grey";a.strokeStyle="grey";a.font="16px Arial";a.textBaseline="middle";for(var b=0,e=a=0,a=0;10>a&&(1>a||0<e);a++){y-=e;e=0;if("outside"===r.indexLabelPlacement){B=y*x;for(b=0;b<m.length;b++){var k=s[b];k.indexLabelTextBlock.x=
C.x+B*Math.cos(k.midAngle);k.indexLabelTextBlock.y=C.y+B*Math.sin(k.midAngle);k.indexLabelAngle=k.midAngle;k.radius=y}for(var t,u,b=0;b<m.length;b++){var k=s[b],z=l(b);if(null!==z){t=s[b];u=s[z];var E=0,E=g(t,u)-w;if(0>E){for(var F=u=t=0;F<m.length;F++)F!==b&&s[F].hemisphere===k.hemisphere&&(s[F].indexLabelTextBlock.y<k.indexLabelTextBlock.y?t++:u++);F=E/(t+u||1)*u;t=-1*(E-F);var G=u=0;"right"===k.hemisphere?(u=q(b,F),t=-1*(E-u),G=q(z,t),+G.toFixed(D)<+t.toFixed(D)&&+u.toFixed(D)<=+F.toFixed(D)&&
q(b,-(t-G))):(u=q(z,F),t=-1*(E-u),G=q(b,t),+G.toFixed(D)<+t.toFixed(D)&&+u.toFixed(D)<=+F.toFixed(D)&&q(z,-(t-G)))}}}}else for(b=0;b<m.length;b++)k=s[b],B="pie"===r.type?0.7*y:0.8*y,E=C.x+B*Math.cos(k.midAngle),F=C.y+B*Math.sin(k.midAngle),k.indexLabelTextBlock.x=E,k.indexLabelTextBlock.y=F;for(b=0;b<m.length;b++)k=s[b],k.indexLabelTextBlock.measureText(),E=E=0,"right"===k.hemisphere?(E=p.x2-(k.indexLabelTextBlock.x+k.indexLabelTextBlock.width+n),E*=-1):E=p.x1-(k.indexLabelTextBlock.x-k.indexLabelTextBlock.width-
n),0<E&&(Math.abs(k.indexLabelTextBlock.y-k.indexLabelTextBlock.height/2-C.y)<y||Math.abs(k.indexLabelTextBlock.y+k.indexLabelTextBlock.height/2-C.y)<y)&&(E/=Math.abs(Math.cos(k.indexLabelAngle)),9<E&&(E*=0.3),E>e&&(e=E)),E=E=0,0<k.indexLabelAngle&&k.indexLabelAngle<Math.PI?(E=p.y2-(k.indexLabelTextBlock.y+k.indexLabelTextBlock.height/2+5),E*=-1):E=p.y1-(k.indexLabelTextBlock.y-k.indexLabelTextBlock.height/2-5),0<E&&Math.abs(k.indexLabelTextBlock.x-C.x)<y&&(E/=Math.abs(Math.sin(k.indexLabelAngle)),
9<E&&(E*=0.3),E>e&&(e=E));b=function(a,b,c){for(var d=[],e=0;d.push(s[b]),b!==c;b=(b+1+m.length)%m.length);d.sort(function(a,b){return a.y-b.y});for(b=0;b<d.length;b++)if(c=d[b],e<a)e+=c.indexLabelTextBlock.height,c.indexLabelTextBlock.text="",c.indexLabelText="",c.indexLabelTextBlock.measureText();else break};z=k=-1;for(F=G=0;F<m.length;F++)if(t=s[F],t.indexLabelText){var H=l(F);null!==H&&(u=s[H],E=0,E=g(t,u),0>E&&f(t,u)?(0>k&&(k=F),H!==k&&(z=H),G+=-E):0<G&&(b(G,k,z),z=k=-1,G=0))}0<G&&b(G,k,z)}c(h.animationEnabled&&
0===h.renderCount?v?60:30:1);d()}var h=this;if(!(0>=a.dataSeriesIndexes.length)){var r=this.data[a.dataSeriesIndexes[0]],m=r.dataPoints,n=10,p=this.plotArea,t=0,u={frame:0,maxFrames:1},s=[],w=2,x=1.3,z=20/180*Math.PI,D=6,C={x:(p.x2+p.x1)/2,y:(p.y2+p.y1)/2},y="inside"===r.indexLabelPlacement?0.95*Math.min(p.width,p.height)/2:0.8*Math.min(p.width,p.height)/2,B=y*x;this.pieDoughnutClickHandler=function(a){u.frame===u.maxFrames&&(a=a.dataPoint,a.exploded=a.exploded?!1:!0,c(v?15:4),1<this.dataPoints.length&&
...
("pixel"!==a||!(d.value<this.minimum||d.value>this.maximum))){var e=this.getPixelCoordinatesOnAxis(d.value);c.strokeStyle=d.color;c.beginPath();B(d.id);var f,g,l,q;c.lineWidth=Math.abs("pixel"===a?d.thickness:this.conversionParameters.pixelPerUnit*d.thickness);if("bottom"===this._position||"top"===this._position)f=g=1===c.lineWidth%2?(e.x<<0)+0.5:e.x<<0,l=this.chart.plotArea.y1,q=this.chart.plotArea.y2;else if("left"===this._position||"right"===this._position)l=q=1===c.lineWidth%2?(e.y<<0)+0.5:e.y<<
0,f=this.chart.plotArea.x1,g=this.chart.plotArea.x2;c.moveTo(f,l);c.lineTo(g,q);c.stroke()}}};y.prototype.renderGrid=function(){if(this.gridThickness&&0<this.gridThickness){var a=this.chart.ctx,c,b=this.chart.plotArea;a.lineWidth=this.gridThickness;a.strokeStyle=this.gridColor;if("bottom"===this._position||"top"===this._position)for(d=0;d<this._labels.length&&!this._labels[d].stripLine;d++)this._labels[d].position<this.minimum||this._labels[d].position>this.maximum||(a.beginPath(),c=this.getPixelCoordinatesOnAxis(this._labels[d].position),
c=1===a.lineWidth%2?(c.x<<0)+0.5:c.x<<0,a.moveTo(c,b.y1<<0),a.lineTo(c,b.y2<<0),a.stroke());else if("left"===this._position||"right"===this._position)for(var d=0;d<this._labels.length&&!this._labels[d].stripLine;d++)this._labels[d].position<this.minimum||this._labels[d].position>this.maximum||(a.beginPath(),c=this.getPixelCoordinatesOnAxis(this._labels[d].position),c=1===a.lineWidth%2?(c.y<<0)+0.5:c.y<<0,a.moveTo(b.x1<<0,c),a.lineTo(b.x2<<0,c),a.stroke())}};y.prototype.renderAxisLine=function(){var a=
this.chart.ctx;if("bottom"===this._position||"top"===this._position){if(this.lineThickness){a.lineWidth=this.lineThickness;a.strokeStyle=this.lineColor?this.lineColor:"black";var c=1===this.lineThickness%2?(this.lineCoordinates.y1<<0)+0.5:this.lineCoordinates.y1<<0;a.beginPath();a.moveTo(this.lineCoordinates.x1,c);a.lineTo(this.lineCoordinates.x2,c);a.stroke()}}else"left"!==this._position&&"right"!==this._position||!this.lineThickness||(a.lineWidth=this.lineThickness,a.strokeStyle=this.lineColor,
c=1===this.lineThickness%2?(this.lineCoordinates.x1<<0)+0.5:this.lineCoordinates.x1<<0,a.beginPath(),a.moveTo(c,this.lineCoordinates.y1),a.lineTo(c,this.lineCoordinates.y2),a.stroke())};y.prototype.getPixelCoordinatesOnAxis=function(a){var c={},b=this.lineCoordinates.width,d=this.lineCoordinates.height;if("bottom"===this._position||"top"===this._position)b/=Math.abs(this.maximum-this.minimum),c.x=this.lineCoordinates.x1+b*(a-this.minimum),c.y=this.lineCoordinates.y1;if("left"===this._position||"right"===
this._position)b=d/Math.abs(this.maximum-this.minimum),c.y=this.lineCoordinates.y2-b*(a-this.minimum),c.x=this.lineCoordinates.x2;return c};y.prototype.getXValueAt=function(a){if(!a)return null;var c=null;"left"===this._position?c=(this.chart.axisX.maximum-this.chart.axisX.minimum)/this.chart.axisX.lineCoordinates.height*(this.chart.axisX.lineCoordinates.y2-a.y)+this.chart.axisX.minimum:"bottom"===this._position&&(c=(this.chart.axisX.maximum-this.chart.axisX.minimum)/this.chart.axisX.lineCoordinates.width*
(a.x-this.chart.axisX.lineCoordinates.x1)+this.chart.axisX.minimum);return c};y.prototype.calculateValueToPixelconversionParameters=function(a){a={pixelPerUnit:null,minimum:null,reference:null};var c=this.lineCoordinates.width,b=this.lineCoordinates.height;a.minimum=this.minimum;if("bottom"===this._position||"top"===this._position)a.pixelPerUnit=c/Math.abs(this.maximum-this.minimum),a.reference=this.lineCoordinates.x1;if("left"===this._position||"right"===this._position)a.pixelPerUnit=-1*b/Math.abs(this.maximum-
this.minimum),a.reference=this.lineCoordinates.y2;this.conversionParameters=a};y.prototype.calculateAxisParameters=function(){var a=this.chart.layoutManager.getFreeSpace();"bottom"===this._position||"top"===this._position?(this.maxWidth=a.width,this.maxHeight=a.height):(this.maxWidth=a.height,this.maxHeight=a.width);var a="axisX"===this.type?500>this.maxWidth?8:Math.max(6,Math.floor(this.maxWidth/62)):Math.floor(this.maxWidth/40),c,b,d,e;"axisX"===this.type?(c=null!==this.sessionVariables.internalMinimum?
this.sessionVariables.internalMinimum:this.dataInfo.viewPortMin,b=null!==this.sessionVariables.internalMaximum?this.sessionVariables.internalMaximum:this.dataInfo.viewPortMax,0===b-c&&(b+=0.4,c-=0.4),d=Infinity!==this.dataInfo.minDiff?this.dataInfo.minDiff:1):"axisY"===this.type&&(c="undefined"===typeof this._options.minimum?this.dataInfo.viewPortMin:this._options.minimum,b="undefined"===typeof this._options.maximum?this.dataInfo.viewPortMax:this._options.maximum,0===b-c?(b+=5,c-=5):(0!==b&&(b+=Math.abs(0.05)),
0!==c&&(c-=Math.abs(0.05))),this.includeZero&&"undefined"===typeof this._options.minimum&&0<c&&(c=0),this.includeZero&&"undefined"===typeof this._options.maximum&&0>b&&(b=0));"axisX"===this.type&&"dateTime"===this.chart.plotInfo.axisXValueType?(e=b-c,this.intervalType||(e/1<=a?(this.interval=1,this.intervalType="millisecond"):e/2<=a?(this.interval=2,this.intervalType="millisecond"):e/5<=a?(this.interval=5,this.intervalType="millisecond"):e/10<=a?(this.interval=10,this.intervalType="millisecond"):
e/20<=a?(this.interval=20,this.intervalType="millisecond"):e/50<=a?(this.interval=50,this.intervalType="millisecond"):e/100<=a?(this.interval=100,this.intervalType="millisecond"):e/200<=a?(this.interval=200,this.intervalType="millisecond"):e/250<=a?(this.interval=250,this.intervalType="millisecond"):e/300<=a?(this.interval=300,this.intervalType="millisecond"):e/400<=a?(this.interval=400,this.intervalType="millisecond"):e/500<=a?(this.interval=500,this.intervalType="millisecond"):e/(1*x.secondDuration)<=
a?(this.interval=1,this.intervalType="second"):e/(2*x.secondDuration)<=a?(this.interval=2,this.intervalType="second"):e/(5*x.secondDuration)<=a?(this.interval=5,this.intervalType="second"):e/(10*x.secondDuration)<=a?(this.interval=10,this.intervalType="second"):e/(15*x.secondDuration)<=a?(this.interval=15,this.intervalType="second"):e/(20*x.secondDuration)<=a?(this.interval=20,this.intervalType="second"):e/(30*x.secondDuration)<=a?(this.interval=30,this.intervalType="second"):e/(1*x.minuteDuration)<=
a?(this.interval=1,this.intervalType="minute"):e/(2*x.minuteDuration)<=a?(this.interval=2,this.intervalType="minute"):e/(5*x.minuteDuration)<=a?(this.interval=5,this.intervalType="minute"):e/(10*x.minuteDuration)<=a?(this.interval=10,this.intervalType="minute"):e/(15*x.minuteDuration)<=a?(this.interval=15,this.intervalType="minute"):e/(20*x.minuteDuration)<=a?(this.interval=20,this.intervalType="minute"):e/(30*x.minuteDuration)<=a?(this.interval=30,this.intervalType="minute"):e/(1*x.hourDuration)<=
a?(this.interval=1,this.intervalType="hour"):e/(2*x.hourDuration)<=a?(this.interval=2,this.intervalType="hour"):e/(3*x.hourDuration)<=a?(this.interval=3,this.intervalType="hour"):e/(6*x.hourDuration)<=a?(this.interval=6,this.intervalType="hour"):e/(1*x.dayDuration)<=a?(this.interval=1,this.intervalType="day"):e/(2*x.dayDuration)<=a?(this.interval=2,this.intervalType="day"):e/(4*x.dayDuration)<=a?(this.interval=4,this.intervalType="day"):e/(1*x.weekDuration)<=a?(this.interval=1,this.intervalType="week"):
e/(2*x.weekDuration)<=a?(this.interval=2,this.intervalType="week"):e/(3*x.weekDuration)<=a?(this.interval=3,this.intervalType="week"):e/(1*x.monthDuration)<=a?(this.interval=1,this.intervalType="month"):e/(2*x.monthDuration)<=a?(this.interval=2,this.intervalType="month"):e/(3*x.monthDuration)<=a?(this.interval=3,this.intervalType="month"):e/(6*x.monthDuration)<=a?(this.interval=6,this.intervalType="month"):(this.interval=e/(1*x.yearDuration)<=a?1:e/(2*x.yearDuration)<=a?2:e/(4*x.yearDuration)<=a?
4:Math.floor(y.getNiceNumber(e/(a-1),!0)/x.yearDuration),this.intervalType="year")),this.minimum=null!==this.sessionVariables.internalMinimum?this.sessionVariables.internalMinimum:c-d/2,this.maximum=this.sessionVariables.internalMaximum?this.sessionVariables.internalMaximum:b+d/2,this.valueFormatString||("year"===this.intervalType?this.valueFormatString="YYYY":"month"===this.intervalType?this.valueFormatString="MMM YYYY":"week"===this.intervalType?this.valueFormatString="MMM DD YYYY":"day"===this.intervalType?
this.valueFormatString="MMM DD YYYY":"hour"===this.intervalType?this.valueFormatString="hh:mm TT":"minute"===this.intervalType?this.valueFormatString="hh:mm TT":"second"===this.intervalType?this.valueFormatString="hh:mm:ss TT":"millisecond"===this.intervalType&&(this.valueFormatString="fff'ms'")),this.intervalStartPosition=this.getLabelStartPoint(new Date(this.minimum),this.intervalType,this.interval)):(this.intervalType="number",e=y.getNiceNumber(b-c,!1),this.interval=this._options&&this._options.interval?
this._options.interval:y.getNiceNumber(e/(a-1),!0),this.minimum=null!==this.sessionVariables.internalMinimum?this.sessionVariables.internalMinimum:Math.floor(c/this.interval)*this.interval,this.maximum=null!==this.sessionVariables.internalMaximum?this.sessionVariables.internalMaximum:Math.ceil(b/this.interval)*this.interval,"axisX"===this.type?(null===this.sessionVariables.internalMinimum&&(this.minimum=c-d/2),this.sessionVariables.internalMaximum||(this.maximum=b+d/2),this.intervalStartPosition=
...
"stepLine"!==e[0].dataSeries.type&&"spline"!==e[0].dataSeries.type&&"area"!==e[0].dataSeries.type&&"stepArea"!==e[0].dataSeries.type&&"splineArea"!==e[0].dataSeries.type&&"stackedArea"!==e[0].dataSeries.type&&"stackedArea100"!==e[0].dataSeries.type?"bar"===e[0].dataSeries.type||"stackedBar"===e[0].dataSeries.type||"stackedBar100"===e[0].dataSeries.type?e[0].dataSeries.axisX.lineCoordinates.y2-e[0].dataSeries.axisX.lineCoordinates.height/Math.abs(e[0].dataSeries.axisX.maximum-e[0].dataSeries.axisX.minimum)*
Math.abs(e[0].dataPoint.x-e[0].dataSeries.axisX.minimum)+0.5<<0:c:e[0].dataSeries.axisY.lineCoordinates.y2-e[0].dataSeries.axisY.lineCoordinates.height/Math.abs(e[0].dataSeries.axisY.maximum-e[0].dataSeries.axisY.minimum)*Math.abs(e[0].dataPoint.y-e[0].dataSeries.axisY.minimum)+0.5<<0;e=-e+10;0<e+this.container.clientHeight+5&&(e-=e+this.container.clientHeight+5-0);this.container.style.left=toolTipLeft;this.container.style.bottom=e+"px";!this.animationEnabled||f?this.disableAnimation():this.enableAnimation()}}};
L.prototype.highlightObjects=function(a){if(this.enabled){var c=this.chart.overlaidCanvasCtx;this.chart.resetOverlayedCanvas();c.save();var b=this.chart.plotArea;c.rect(b.x1,b.y1,b.width,b.height);c.clip();c.beginPath();for(b=0;b<a.length;b++){var d=a[b];if((d=this.chart._eventManager.objectMap[d.dataSeries.dataPointIds[d.index]])&&d.objectType&&"dataPoint"===d.objectType){var e=this.chart.data[d.dataSeriesIndex],f=d.dataPointIndex;if("line"===e.type||"stepLine"===e.type||"spline"===e.type||"scatter"===
e.type||"area"===e.type||"stepArea"===e.type||"splineArea"===e.type||"stackedArea"===e.type||"stackedArea100"===e.type)e=e.getMarkerProperties(f,d.x1,d.y1,this.chart.overlaidCanvasCtx),e.size=Math.max(1.5*e.size<<0,10),e.borderColor=e.borderColor||"#FFFFFF",e.borderThickness=e.borderThickness||Math.ceil(0.1*e.size),H.drawMarkers([e]);else if("bubble"===e.type)e=e.getMarkerProperties(f,d.x1,d.y1,this.chart.overlaidCanvasCtx),e.size=d.size,e.color="white",e.borderColor="white",c.globalAlpha=0.3,H.drawMarkers([e]),
c.globalAlpha=1;else if("column"===e.type||"stackedColumn"===e.type||"stackedColumn100"===e.type||"bar"===e.type||"stackedBar"===e.type||"stackedBar100"===e.type)c.globalAlpha=0.3,J(c,d.x1,d.y1,d.x2,d.y2,"white",!1,!1,!1,!1),c.globalAlpha=1;else if("pie"===e.type||"doughnut"===e.type)c.globalAlpha=0.3,ja(c,d.center,d.radius,"white",e.type,d.startAngle,d.endAngle),c.globalAlpha=1}}c.globalAlpha=1;c.restore()}};L.prototype.getToolTipInnerHTML=function(a){a=a.entries;for(var c="",b=null,d=null,e=0,f=
"",g=!0,l=0;l<a.length;l++)if(a[l].dataSeries.toolTipContent||a[l].dataPoint.toolTipContent){g=!1;break}if(g&&this.content&&"function"===typeof this.content)c=this.content({entries:a});else if(1<a.length)for(l=0;l<a.length;l++){b=a[l].dataSeries;d=a[l].dataPoint;e=a[l].index;f="";0===l&&(g&&!this.content)&&(f+="undefined"!==typeof this.chart.axisX.labels[d.x]?this.chart.axisX.labels[d.x]:"{x}",f+="</br>");if("line"===b.type||"stepLine"===b.type||"spline"===b.type||"area"===b.type||"stepArea"===b.type||
"splineArea"===b.type||"column"===b.type||"bar"===b.type||"scatter"===b.type||"stackedColumn"===b.type||"stackedColumn100"===b.type||"stackedBar"===b.type||"stackedBar100"===b.type||"stackedArea"===b.type||"stackedArea100"===b.type)f+=d.toolTipContent?d.toolTipContent:b.toolTipContent?b.toolTipContent:this.content&&"function"!==typeof this.content?this.content:"<span style='\"'color:{color};'\"'>{name}:</span>&nbsp;&nbsp;{y}";else if("bubble"===b.type)f+=d.toolTipContent?d.toolTipContent:b.toolTipContent?
b.toolTipContent:this.content&&"function"!==typeof this.content?this.content:"<span style='\"'color:{color};'\"'>{name}:</span>&nbsp;&nbsp;{y}, &nbsp;&nbsp;{z}";else if("pie"===b.type||"doughnut"===b.type)f+=d.toolTipContent?d.toolTipContent:b.toolTipContent?b.toolTipContent:this.content&&"function"!==typeof this.content?this.content:"&nbsp;&nbsp;{y}";c+=this.chart.replaceKeywordsWithValue(f,d,b,e);l<a.length-1&&(c+="</br>")}else{b=a[0].dataSeries;d=a[0].dataPoint;e=a[0].index;if("line"===b.type||
"stepLine"===b.type||"spline"===b.type||"area"===b.type||"stepArea"===b.type||"splineArea"===b.type||"column"===b.type||"bar"===b.type||"scatter"===b.type||"stackedColumn"===b.type||"stackedColumn100"===b.type||"stackedBar"===b.type||"stackedBar100"===b.type||"stackedArea"===b.type||"stackedArea100"===b.type)f=d.toolTipContent?d.toolTipContent:b.toolTipContent?b.toolTipContent:this.content&&"function"!==typeof this.content?this.content:"<span style='\"'color:{color};'\"'>"+(d.label?"{label}":"{x}")+
" :</span>&nbsp;&nbsp;{y}";else if("bubble"===b.type)f=d.toolTipContent?d.toolTipContent:b.toolTipContent?b.toolTipContent:this.content&&"function"!==typeof this.content?this.content:"<span style='\"'color:{color};'\"'>"+(d.label?"{label}":"{x}")+":</span>&nbsp;&nbsp;{y}, &nbsp;&nbsp;{z}";else if("pie"===b.type||"doughnut"===b.type)f=d.toolTipContent?d.toolTipContent:b.toolTipContent?b.toolTipContent:this.content&&"function"!==typeof this.content?this.content:(d.name?"{name}:&nbsp;&nbsp;":d.label?
"{label}:&nbsp;&nbsp;":"")+"{y}";c+=this.chart.replaceKeywordsWithValue(f,d,b,e)}return c};L.prototype.enableAnimation=function(){this.container.style.WebkitTransition||(this.container.style.WebkitTransition="left .2s ease-out, bottom .2s ease-out",this.container.style.MozTransition="left .2s ease-out, bottom .2s ease-out",this.container.style.MsTransition="left .2s ease-out, bottom .2s ease-out",this.container.style.transition="left .2s ease-out, bottom .2s ease-out")};L.prototype.disableAnimation=
...
this.options=b._options},addColorSet:function(a,c){R[a]=c},addCultureInfo:function(a,c){ga[a]=c}};ta.Chart.version="v1.4.0 GA";window.CanvasJS=ta})();
/*
